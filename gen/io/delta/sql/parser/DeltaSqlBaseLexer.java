// Generated from /Users/yxl/gitwork/delta/src/main/antlr4/io/delta/sql/parser/DeltaSqlBase.g4 by ANTLR 4.7.2
...
public class DeltaSqlBaseLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "BY", "COMMENT", "CONVERT", "DELTA", 
			"DESC", "DESCRIBE", "DETAIL", "GENERATE", "DRY", "HISTORY", "HOURS", 
			"LIMIT", "MINUS", "NOT", "NULL", "FOR", "TABLE", "PARTITIONED", "RETAIN", 
			"RUN", "TO", "VACUUM", "STRING", "BIGINT_LITERAL", "SMALLINT_LITERAL", 
